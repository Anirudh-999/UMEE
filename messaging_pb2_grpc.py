...
class MessagingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Connect = channel.unary_stream(
                ...
                request_serializer=messaging__pb2.ConnectRequest.SerializeToString,
...
def add_MessagingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Connect': grpc.unary_stream_rpc_method_handler(
                    servicer.Connect,
                    request_deserializer=messaging__pb2.ConnectRequest.FromString,
...
class MessagingService(object):
    ...
    def Connect(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/MessagingService/Connect',
            messaging__pb2.ConnectRequest.SerializeToString,
